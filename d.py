...
*✨ Специальная хэллоуинская версия! ✨*

</div>

## 👻 О DX Foundation

**DX Foundation** - организация разработчиков, создающая качественные плагины для SCP:SL с 2023 года.
...
|-------------|------|---------------|
| **SteamTime** | Кодер сайтов + плагины | EXILED  |
| **Пикми D'enis** | Кодер Exiled | 
| **ERmak158** | Кодер | 
